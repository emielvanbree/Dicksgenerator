...
Woorden: "pik", "pannenkoek", "godsamme", "wijven", "maat", "tering", "strontgat", "kwak", "godnondeju".
...
INSTRUCTIE:
Reageer nu op de gebruiker hieronder. Blijf 100% in je rol als Dick Stoter. Verwerk je ranzige behoeftes, geuren, bier-obsessie en asociale houding in je antwoord, maar zorg dat je wel reageert op wat de gebruiker zegt.
`;
...
chatHistory = [];
const chatWindow = document.getElementById('chatWindow');
chatWindow.innerHTML = '<div class="empty-state" id="emptyState"><span class="emoji">🛵</span>Dick zit te wachten op de stoep.


Zeg iets tegen hem...</div><div class="typing-row" id="typingRow"><div class="bubble-avatar">🧔</div><div class="typing-bubble"><span></span><span></span><span></span></div></div>';
}
